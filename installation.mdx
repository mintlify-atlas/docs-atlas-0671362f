...
<Steps>
  ...
  <Step title="Run database migrations">
    ...
    This creates all 25 tables defined across the migration history, including `batches`, `tank_units`, `technical_receptions`, `tank_technical_reviews`, `dispatches`, `dispatch_lines`, and the full catalog set.
  </Step>

...
description: "Create and manage OxygenDispatch user accounts with role-based access. Control active status and reset passwords — restricted to PROGRAMADOR and ADMINISTRADOR roles."
---

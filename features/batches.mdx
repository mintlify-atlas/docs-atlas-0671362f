...
description: "Create and manage incoming shipment batches in OxygenDispatch. Each batch captures supplier details, voucher data, and generates serialized tank units."
---

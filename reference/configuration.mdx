---
title: "OxygenDispatch Configuration Reference"
sidebarTitle: "Configuration"
description: "Configuration reference for OxygenDispatch — application settings, database connection, queue driver, file storage, and PDF generation."
---
